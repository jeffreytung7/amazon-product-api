    ...
    grabProduct(body, p) {
        ...
        for (let key in scrapingResult) {
            try {
                ...
                console.log('jef: div[data-asin=${key}]', $(`div[data-asin=${key}]`))
                console.log('jef: titleThumbnailSearch', titleThumbnailSearch)
                ...
                if (ratingSearch) {
                    console.log('jef: ratingSearch', ratingSearch)
                ...
                if (titleThumbnailSearch) {
                    ...
                    console.log('jef: attribs', titleThumbnailSearch.attribs)
                }
            } catch (err) {
                continue;
            }
